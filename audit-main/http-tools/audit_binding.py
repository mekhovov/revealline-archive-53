...
COMMIT = '069890158c9f2c766e334564f752716491057727'
TREE = 'a3d73bb62c93bed4fdcc494410960aae133115f7'
SOURCE = 'f6e592bacda85db5efcf68f5be3ad2240073b661'
SOURCE_TREE = '15dcbb22f845ad9825316c54321efa22e5a0054e'
INVENTORY_SHA = '2bbaf2c01c3d969da77dd81840094707c661c96aec0fd65576dff1b61030760d'
EXPECTED_FILES = 3887
EXPECTED_BYTES = 614750347
...
def validate_execution_binding():
    ...
    require(request['runId'] == 35790200099 and set(request['pins']) == ROLES, 'Wrong production run or incomplete authority')
    ...
    with zipfile.ZipFile(io.BytesIO(zip_raw)) as archive:
        ...
        require(receipt['format'] == 'revealline-metadata-pages-artifact.v1' and receipt['controllerCommit'] == COMMIT and receipt['controllerTree'] == TREE and receipt['currentVersion'] == 'v0.85.0' and receipt['gameSourceRevision'] == SOURCE and receipt['qualifiedSourceTree'] == SOURCE_TREE, 'Wrong frozen receipt source/controller')
        require(receipt['publishable'] is True and receipt['browserAdmissionsRequired'] is True and receipt['admittedArchives'] == 53, 'Receipt is not actual production eligible')
        ...
        require(extraction['version'] == 'v0.85.0' and extraction['gameSourceRevision'] == SOURCE and extraction['distributionSha256'] == '22935ce25164a6239301597cbdba58aa0a9a918432f0e16aadd212ab45e71bbc' and extraction['manifestSha256'] == '8e830f67352fb76af41904b8a38d98e25b66a1bdc8ce71d729572d4af5583be5' and extraction['crcAndHashesVerified'] is True, 'Frozen ZIP source/hash identity mismatch')
